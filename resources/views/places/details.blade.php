            ...
            <div class="bg-white shadow-lg rounded p-4 h-52">
                ...
                <div class="bg-white col-span-2 shadow-lg rounded p-5 grid grid-cols-1 lg:grid-cols-3">
                    ...
                    <div class="mr-2 col-span-2">
                        ...
                        <div class="text-right">
                            <progress value="{{ $serviceRating }}" class="w-full" max="5"
                                title="{{ round($serviceRating, 1) }}"></progress>
                        </div>
                        <!-- end 4 -->
                        <div class="text-right">
                        ...
                        <div class="text-right">
                            <progress value="{{ $qualityRating }}" class="w-full" max="5"
                                title="{{ round($qualityRating, 1) }}"></progress>
                        </div>
                        <!-- end 3 -->
                        <div class="text-right">
                        ...
                        <div class="">
                            <progress value="{{ $cleanlinessRating }}" class="w-full" max="5"
                                title="{{ round($cleanlinessRating, 1) }}"></progress>
                        </div>
                        <!-- end 2 -->
                        <div class="text-right">
                        ...
                        <div class="">
                            <progress value="{{ $pricingRating }}" class="w-full" max="5"
                                title="{{ round($pricingRating, 1) }}"></progress>
                        </div>
                        <!-- end 1 -->
                    </div>
                    <!-- end row -->
                            ...
                            <div class="review-block ">
                                <div class="grid grid-cols-3 p-5">
                                    ...
                                    <div class="col-span-2">
                                        <div class="rating">
                                            <x-rating :rating="$review->avgRating()" />
                                        </div>
                ...
                <div id="review-div" class="bg-white col-span-2 shadow-lg rounded p-5">
                    ...
                    @else
                        <x-alert color="red" message="يجب تسجيل الدخول لكي يمكنك التعليق" />
                    @endauth
                </div>
            </div>
        </div>
